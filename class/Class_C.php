...
class C
{
 	...
 	public function __construct(private int $id=0,private string $nom='',private string $prenom='',private array $vaccin=array()) {
	...
	{
		$affiche= "<br>Presentation de l'objet de C N° : ".$this->id;
	...
	{
		$affiche= "<br>Presentation des vaccins de l'objet de C ";
		$i=0;
